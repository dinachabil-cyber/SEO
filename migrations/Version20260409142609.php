 ...
 */
final class Version20260409142609 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event_assigned_users (event_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_EA9EC4E71D89352C (event_id), INDEX IDX_EA9EC4E7A76ED395 (user_id), PRIMARY KEY (event_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_520_ci` ENGINE = InnoDB COMMENT = \'\' ');
